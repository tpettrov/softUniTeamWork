...
namespace BlogSystem.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Body,Author_Id,Date")] Post post)
        {
        ...
        [Authorize(Roles = "Administrators")]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Body,Author_Id,Date")] Post post)
        {
            if (ModelState.IsValid)
            {
